...
import { Workflow, Plus, Play, Pause, Edit, Trash2, Database, MessageSquare } from "lucide-react";
          ...
          <Dialog>
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border rounded-lg p-4 space-y-3">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label>Template/Conteúdo</Label>
                        <Select>
                          <SelectTrigger>
                            <SelectValue placeholder="Selecione o template" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="template1">Recuperação NPS</SelectItem>
                            <SelectItem value="template2">Pesquisa Satisfação</SelectItem>
                            <SelectItem value="template3">Welcome Premium</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
                ...
                <Button className="w-full">Criar Automação</Button>
              </div>
            </DialogContent>
          </Dialog>
        </div>
